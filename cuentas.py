...
CUENTAS = [
    ## Sharynnel
    {
        ...
        'preguntas': {
            ...
            'pregunta2': '¿Cuál es la profesión/ocupación de su madre?', 'respuesta2': 'maestra',
            'pregunta3': '¿Cuál es el segundo nombre de su hermano(a) mayor?', 'respuesta3': 'Nicol',
            'pregunta4': '¿Cuál es el nombre de su cantante/grupo favorito en la universidad?', 'respuesta4': 'Ariana Grande',
    ...
    ## Elizabeth
    {
        ...
        'preguntas': {
            ...
            'pregunta2': '¿A qué hora del dia nació su hijo(a) mayor?', 'respuesta2': '11am',
            'pregunta3': '¿En qué ciudad nació su abuelo materno?', 'respuesta3': 'Cartagena',
            'pregunta4': '¿En qué año conoció a su esposo(a)?', 'respuesta4': '1990',
